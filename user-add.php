...
<div class="all-card">
    <div class="from-add-user">
        <h3 class="text-center mb-4 fw-bold" style="color: #1e293b;">Add New User</h3>

        <form method="post">
            <div class="mb-3">
                <label for="username" class="form-label fw-medium text-secondary">Username</label>
                <input name="username" type="text" class="form-control" id="username" placeholder="e.g. Username" required>
            </div>
