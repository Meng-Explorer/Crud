    ...
    <div class="from-add-user">
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <input name="name" type="text" class="form-control" id="username" placeholder="e.g. Name" required>
            </div>

            <div class="mb-3">
                <label for="password" class="form-label fw-medium text-secondary">Name English</label>
                <input name="nameEnglish" type="text" class="form-control" id="password" placeholder="e.g. Name English" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input name="note" type="text" class="form-control" id="email" required>
            </div>
...
if (isset($_POST['btn_save'])) {
    ...
    $note = $_POST['note'];
    $user = new user();
    $user->insertInstruct($name, $nameEnglish, $department, $note);
