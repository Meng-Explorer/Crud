    ...
    <div class="from-add-user">
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <input value="<?php echo $data['name'] ?>" name="username" type="text" class="form-control" id="username" placeholder="e.g. Username" required>
            </div>
            <div class="d-flex gap-3">
                <a href="instruct.php" type="button" class="btn btn-cancel w-100">Cancel</a>
                <button type="submit" name="btn_save" class="btn btn-danger  w-100">Delete Instruct</button>
            </div>
        </form>
    </div>
</div>
